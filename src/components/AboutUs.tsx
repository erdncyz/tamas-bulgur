...
export default function AboutUs() {
  ...
  return (
    <section id="about" className="py-14 sm:py-18 lg:py-24 bg-brand-cream dark:bg-gray-800 transition-colors duration-300 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-serif font-bold text-brand-brown dark:text-white mb-6 sm:mb-8 leading-tight">
              {language === "tr" 
                ? "1994'ten Beri\nKaliteden Taviz Vermiyoruz"
                : "Quality Never\nCompromised Since 1994"
              }
            </h2>
            <div className="space-y-4 sm:space-y-6 text-gray-700 dark:text-gray-300 leading-relaxed text-base sm:text-lg">
              <p>
                {language === "tr"
